  ...
  const AboutSection = () => {
    ...
    const skills = [
      ...
      { 
        category: 'Backend', 
        items: ['Node.js', 'Microservices', 'Pyhton', 'REST APIs', 'Nest.js'],
        icon: '⚙️'
      },
      { 
        category: 'Frontend', 
        items: ['React', 'TypeScript', 'Next.js', 'Jest'],
        icon: '🎨'
      },
      { 
        category: 'Data', 
        items: ['MongoDB', 'PostgreSQL', 'Redis', 'Data Modeling'],
        icon: '📊'
      }
    ];
          ...
          >
            ...
            <div className="text-center mb-20">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
                Desarrollador Fullstack especializado en arquitecturas de alto rendimiento con 6 años de experiencia  | Certificado AWS Solutions Architect.
              </p>
            </div>
